...
public class UpdateAnswerTask extends AsyncTask<String,Void,String> {
    ...
    protected void onPostExecute(String s) {
        //where to go
        Log.i("talat","updateans activity Start");
        int nxt=0,f=0;
        ...
        if(f==1){
            ...
            Intent temp = new Intent(context, TempQuestionActivity.class);
            ...
            Log.i("talat","updateans activity end");
